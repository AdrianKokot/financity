...
namespace Financity.Persistence.Migrations
{
    ...
    [Migration("20220429202519_fix-auditable-entity-updated-by-property")]
    partial class fixauditableentityupdatedbyproperty
    {
            ...
            modelBuilder.Entity("Financity.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "PLN",
                            CreatedAt = new DateTime(2022, 4, 29, 22, 25, 19, 215, DateTimeKind.Local).AddTicks(9248),
                            CreatedBy = "System"
                        });
                });
