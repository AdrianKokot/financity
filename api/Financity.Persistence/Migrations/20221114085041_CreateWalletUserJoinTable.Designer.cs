...
namespace Financity.Persistence.Migrations
{
    ...
    [Migration("20221114085041_CreateWalletUserJoinTable")]
    partial class CreateWalletUserJoinTable
    {
            ...
            modelBuilder.Entity("Financity.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6450bd1-8c6f-4105-8927-7fad5242664c"),
                            Code = "PLN",
                            Name = "Polski Złoty"
                        },
                        new
                        {
                            Id = new Guid("ebd5787e-ef20-40d1-8867-e1089f197179"),
                            Code = "EUR",
                            Name = "Euro"
                        },
                        new
                        {
                            Id = new Guid("b83415ce-6c66-4a2b-acb1-f29429097ad3"),
                            Code = "USD",
