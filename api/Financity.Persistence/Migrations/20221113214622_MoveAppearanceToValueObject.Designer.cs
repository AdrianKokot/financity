...
namespace Financity.Persistence.Migrations
{
    ...
    [Migration("20221113214622_MoveAppearanceToValueObject")]
    partial class MoveAppearanceToValueObject
    {
            ...
            modelBuilder.Entity("Financity.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3729bbe9-6321-453f-8851-9a98b7130479"),
                            Code = "PLN",
                            Name = "Polski Złoty"
                        },
                        new
                        {
                            Id = new Guid("805e3f33-8ead-4c42-a9c9-263480c38555"),
                            Code = "EUR",
                            Name = "Euro"
                        },
                        new
                        {
                            Id = new Guid("45cc816b-c933-4fa0-be64-fff9542ce98b"),
                            Code = "USD",
