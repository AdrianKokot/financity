...
namespace Financity.Persistence.Migrations
{
    ...
    [Migration("20221109174929_AddUsers")]
            ...
            modelBuilder.Entity("Financity.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("942f9ce1-5d5c-4a50-8416-6ab020edeb59"),
                            Code = "PLN",
                            Name = "Polski Złoty"
                        },
                        new
                        {
                            Id = new Guid("7a616e39-7264-4233-a766-063a997d0afc"),
                            Code = "EUR",
                            Name = "Euro"
                        },
                        new
                        {
                            Id = new Guid("699d3af0-1739-4901-9a41-8a75ab8709b8"),
                            Code = "USD",
