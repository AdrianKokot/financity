...
namespace Financity.Persistence.Migrations
{
    ...
    [Migration("20221118074944_AddExchangeRateToTransaction")]
    partial class AddExchangeRateToTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Financity.Domain.Entities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("392902ec-f1d1-4198-a5d5-49d56257efa4"),
                            Code = "PLN",
                            Name = "Polski Złoty"
                        },
                        new
                        {
                            Id = new Guid("a6bbe70a-9794-4c06-9728-efd1f59e2327"),
                            Code = "EUR",
                            Name = "Euro"
                        },
                        new
                        {
                            Id = new Guid("34f90ceb-f4b5-4a36-a105-c031e0206082"),
                            Code = "USD",
